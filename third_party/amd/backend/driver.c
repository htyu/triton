...
static PyObject *getDeviceProperties(PyObject *self, PyObject *args) {
  ...
  return Py_BuildValue("{s:i, s:i, s:i, s:i, s:i, s:s, s:i}", "max_shared_mem",
                       props.sharedMemPerBlock, "max_num_regs",
                       props.regsPerBlock, "multiprocessor_count",
                       props.warpSize, "warp_size", props.multiProcessorCount,
                       "sm_clock_rate", props.clockRate, "mem_clock_rate",
                       props.memoryClockRate, "mem_bus_width",
                       props.memoryBusWidth, "arch", props.gcnArchName,
